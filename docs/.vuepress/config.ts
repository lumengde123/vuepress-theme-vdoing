...
const DOMAIN_NAME = 'vdoing.1sj.top' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'lumengde123/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'lumengde', // 必需
      link: 'https://github.com/lumengde123', // 可选的
    },
